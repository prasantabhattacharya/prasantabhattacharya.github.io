...
5. Bhattacharya, P., Loh, S. and Yang, Y. (2023). Influence of Context in Emotion Processing: Integrative review and Implications for Affective Computing.
6. Ang, E., Bhattacharya, P., and Lim, A. (2023). Estimating Policy Effects in a Social Network with Independent Set Sampling.
7. Dan, D., Bhattacharya, P., Phan, T.Q., and Airoldi, E. (2021). The Effect of Online Collaborative Peer Influence on Academic Performance: A Three-Stage Co-evolution model of Social Network and Individual Behavior. 
8. Belik, I., Bhattacharya, P., and Knudsen, E.S. (2022). The Red or the Blue Pill? A Case for Simulated Data in Organizational Network Research.
9. Shan, D., Bhattacharya, P., Kao, B., and Phan, T.Q. (2021). Characterizing Amateur Tutoring Behavior on a Large Online Learning Platform.
10. Tan, T., Bhattacharya, P., and Phan, T.Q. (2018). Predicting Micro-loan Default Behavior using Mobile Data: A Spatio-Network Approach.
11. Bhattacharya, P., Tan, T., and Phan, T.Q. Assessing Peer-effects from Egocentric Borrower Networks: Evidence from an Emerging Micro-lending Community.
...
17. Gupta, R.K., Bhattacharya, P., Yang, Y. (2019). What Constitutes Happiness? Predicting and Characterizing the Ingredients of Happiness using Emotion Intensity Analysis. In Proc. of the 2nd Workshop on Affective Content Analysis @ AAAI (AffCon2019), Honolulu (Hawaii).
